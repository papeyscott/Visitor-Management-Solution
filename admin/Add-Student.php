...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($error)){
    insert($conn, 'student', $_POST);
    $success = "Student Added";
    // $succ = preg_replace('/\s+/', '_', $success);
    // workRate($dbconn,$sess);
    header("Location:View-Student.php?success=$success");
  }
}
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add a Student</h4> </div>
...
<form class="needs-validation" action="" method="post" >
  <div class="form-row">
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="email" name="email" class="form-control" id="validationCustom02" placeholder="Email" value="Otto" required>
