...
<div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" method="POST" action="">
                 <h2 class="text-success"><b>SIGN OUT</b></h2>
                <br> <br>
               ...
               <div class="card" >
                    ...
                    <p class="card-text" style="text-align: center;">Thanks For Visiting.</p>
                   
                </div>
                
                <br><br>
                <button class="btn btn-lg btn-primary btn-block btn-signin" name="submit" type="submit">Check Out</button>
            </form><!-- /form -->
