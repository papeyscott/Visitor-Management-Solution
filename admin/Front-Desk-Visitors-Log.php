...
$pre_visitor = getSpecificData($conn,'visitors','type',1);
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Front Desk Visitors Log</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                            <li class="active">Front Desk Visitors Log</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                  ...
                  <h2 class="postin-title">error! '.$msg.' </h2>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Front Desk Visitors Log</h3>
