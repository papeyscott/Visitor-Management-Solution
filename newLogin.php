...
$message   = '<html>
                <body>
                    ...
                    <img src="http://greenlandhall.org/visitors/'.$result['image'].'" width="100" height="100"  >
                       ...
                       <table>
        <tr>
            <td background="http://greenlandhall.org/visitors/'.$result['image'].'" width="100" height="100">
                    ...
                    <p>Every staff member is responsible for their visitors, therefore all host should make sure their visitors adhere strictly to the <a href="">Greenland Hall Visitors Policy</a></p>
                </body>
            </html>';
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" method="POST" action="" enctype="multipart/form-data">
              ...
              echo $display ?>
                <select onchange="specify(this.name, this);" class="form-control" name="purpose" required>
