...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($_POST['vnumber'])){
    $error['vnumber']="Enter Vehicle Number / Phone number";
  }
  ...
  $c= $_POST['whom'].' you have a parcel from '.$_POST['name'].' waiting for you at the mail room';
  $d='GLH';
  $e=$detail['phone'];
...
<body class="center-screen">
  ...
  <?php $display = displayErrors($error, 'address');
            ...
            <textarea name="address" placeholder="Company Address *" class="form-control"><?php if(isset($_POST['address'])){ echo $_POST['address'];}?></textarea>
...
<br>
                ...
                <?php $display = displayErrors($error, 'vnumber');
                    echo $display ?>
                <input type="text" name="vnumber" class="form-control" placeholder="Vehicle Registration Number or Phone Number *" value="<?php if(isset($_POST['vnumber'])){ echo $_POST['vnumber'];}?>" required>
...
if(element.value == 'Construction' || element.value == 'Food' || element.value == 'others' || element.value =='Book' ){
  element.name = "";
