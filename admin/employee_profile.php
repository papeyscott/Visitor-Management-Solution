...
if(empty($error)){
  ...
  $new['id'] = $_GET['vdata'];
    update($conn,'employee',$clean,'id',$new,$_GET['ret']);
}
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12">Staff Status(<?php echo $value['staff_status'] ?>)</label>
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="staff_status">
