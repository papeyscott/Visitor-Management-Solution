...
if(isset($_GET['today'])){
 $visitor =   getSpecificDataToday($conn,'visitors','status','signed in');
}else{
   $visitor = getSpecificData($conn,'visitors','status','signed in');
}
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Signed In Visitors</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                            <li class="active">Signed In Visitors</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                   ...
                   function pront(){
                     printJS({ printable: 'fedit',documentTitle:'GLH VISITORS LOG',type:'html',headerStyle:'font-weight:300;',targetStyle:['height','font-family','float','width','content','clear','color','margin-right','margin-left','text-align','font-size','font-weight','vertical-align','margin-top','border','background-color','position','left','right'],honorColor:'true',font_size:'16pt'});
                       ...
                       <!-- <div  id="fedit" style="width:100%; display: none " class=""> -->
                        ...
                        <div id="fedit" class="white-box">
                            <h3 class="box-title">Signed In Visitors Log</h3>
                        ...
                        <div class="row col-md-6">
                            ...
                            <div class="col-md-6">
                                 ...
                                 <p class=" text-success"><?php echo $value['status'] ?></p>
                                 <p class=" text-danger"><?php echo $value['last_logout']." ".$value['last_login_date'] ?></p>
                            </div>
